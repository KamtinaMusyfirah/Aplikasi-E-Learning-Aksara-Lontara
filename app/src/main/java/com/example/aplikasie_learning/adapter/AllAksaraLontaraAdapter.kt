...
import com.example.aplikasie_learning.databinding.ItemAllAksaraBinding
import com.example.aplikasie_learning.model.AksaraLontara

class AllAksaraLontaraAdapter : RecyclerView.Adapter<AllAksaraLontaraAdapter.ViewHolder>(){
    ...
    class ViewHolder(private val aksaraLontaraItemBinding: ItemAllAksaraBinding)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemAllAksaraBinding.inflate(LayoutInflater.from(parent.context), parent, false)
